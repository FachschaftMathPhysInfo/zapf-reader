  ...
  \subsection*{Protokoll}
    \paragraph{Anzahl der Vertrauenspersonen & Wahlverfahren}
      \begin{itemize}
        ...
        \item Jenny (FUB): Die Wahl legitimiert nicht, dass dieser Person vertraut wird, sondern das Vertrauen gibt jede einzelne Person. Daher ist eine Begrenzung der VP Anzahl nicht gut. Wichtig ist, dass jede_r eine Ansprechperson findet.
        ...
        \item Marcus (Alumni): Hat das Dokument gefunden ( https://zapfev.de/reader/2017_SoSe_Berlin_vorlaeufig.pdf (S.68f)). Es gibt keinen weiteren Beschluss zur Schweigepflicht. Dort steht genau drin, wie das mit Bildern der VP aushängen und so sein soll. Da sollte der StAPF auch mit drauf achten, dass die Orga das macht. Kommt auf die StAPF Checkliste.
