...
Wir haben bei uns aktuell ein System zur Verteilung der Semestergelder nach folgendem System: \\
      ...
      \paragraph{Antworten}
        \begin{itemize}
          ...
          \item Innsbruck: Wer darf Überschüsse beantragter Gelder behalten? $\rightarrow$ Greifswald Frankfurt, Göttingen, Braunschweig, WWU, Bonn, Siegen, Halle, Dresden, Cottbus, KiT, Erlangen, Freiburg, Essen
          \item Hat jemand noch eine nicht-genannte Lösung für \flqq kleine Fachschaften brauchen auch mal Geld, aber basierend auf den Studierendenzahlen funktioniert das nicht\frqq?
            \begin{itemize}
              \item Augsburg: Für Umfragen vom Institut angestellt und eigenen Raum.
...
\begin{itemize}
    ...
    \subsubsection*{Größe des Fachschaftsrates}
      ...
      \begin{itemize}
        ...
        \item Welche Erfahrung habt ihr mit großen Räten gemacht? Besitzen ``freie Helfika'' auch ein Stimmrecht in Abstimmungen?
      \end{itemize}
